...
int main(){
    ...
    // Load the image
    Mat image = imread("/content/Parallel-Histogram-Equalization/code/sequential_histogram_equalization/img/tree1.jpg", CV_LOAD_IMAGE_COLOR);
    ...
    imwrite("/content/Parallel-Histogram-Equalization/code/sequential_histogram_equalization/out.jpg",image);		
    waitKey();
