...
int main(){
    ...
    // Load the image
    Mat image = imread("/content/Parallel-Histogram-Equalization/code/OMP_histogram_equalization/img/gigante.jpg");
   ...
   // namedWindow("Original Image");
    ...
    imwrite("/content/Parallel-Histogram-Equalization/code/OMP_histogram_equalization/out.jpg",image);
